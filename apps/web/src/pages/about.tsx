      ...
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-6 px-6 py-12 md:flex-row md:items-start md:gap-10">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mb-6 text-base leading-relaxed">
            Withsy is your home for thoughtful, user-focused tools. Starting
            with Withsy Chat, we’re building a village of products that are
            gentle, customizable, and designed to grow with you. Our mission is
            to create technology that listens, adapts, and stays by your side.
          </p>
