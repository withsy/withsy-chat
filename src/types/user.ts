...
export type UserPrefsSchema = zInfer<typeof UserPrefsSchema>;

export const UpdateUserPrefs = UserPrefsSchema.partial();
...
export const UserPrefs = User.pick({ preferences: true });
